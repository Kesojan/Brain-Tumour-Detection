...
#              detect the severity of a patients Brain tumour
#              with approx 87.9% accuracy (Medical image classification)
...
#Get a count of the number of patients with a brain tumour
df['cardio'].value_counts()

#Visualize the data 
sns.countplot(df['cardio'])

#Look at the number of people with a brain tumour that exceed number of people without brain cancer
